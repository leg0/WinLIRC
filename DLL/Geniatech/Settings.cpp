...
void Settings::saveSettings() {
	...
	//WritePrivateProfileString(_T("GeniatechBDAPlugin"),_T("DeviceNumber"),temp, currentDirectory);
}
...
void Settings::loadSettings() {
	...
	//devNumber	= GetPrivateProfileInt(_T("GeniatechBDAPlugin"),_T("DeviceNumber"),0,currentDirectory);
}