 ...
 *############################################################
 *
 * Module name  : tmNxTypes.h  %version: 1 %
 *
 * Last Update  : %date_modified: Wed,Jul 10,12:51:30 2002 %
 *
...
//
#define TM_CHARS_TO_UINT32(a,b,c,d)     \
...
//#elif      (TMFL_OS_IS_VXWORKS || TMFL_OS_IS_HPUNIX || TMFL_OS_IS_NULLOS || TMFL_OS_IS_LINUX)
#elif      (TMFL_OS_IS_VXWORKS || TMFL_OS_IS_NULLOS || TMFL_OS_IS_LINUX)
//
