//-----------------------------------------------------------------------------
// MoReUse - 2002-03-21  Continuus Version 24
//
// Changed
//    Link to tmtypes.h replaced by link to tmNxTypes.h
//
// Added
//
// Removed
...
#define CID_LAYER_TMNL      (0xE << CID_LAYER_BITSHIFT)  // Nodes Layer

//
// "New" (i.e. after 2002-01-31) Component Layers depend on the component type and class
// So we can have an identical layer value for each type/class combination
// In order not to break existing code that assumes that layers are unique, we start new
// layers at 0x7
//
//------------------ CTYP_BUS_NOTYPE dependent layer definitions ------------
#define CID_LAYER_UDS      (0x7 << CID_LAYER_BITSHIFT)  // USB Device Stack Layer
#define CID_LAYER_UHS      (0x8 << CID_LAYER_BITSHIFT)  // USB Host stack Layer
#define CID_LAYER_UOTG     (0x9 << CID_LAYER_BITSHIFT)  // USB OTG stack layer
...
//
#define CID_COMP_CLOCK          (TAG(0x01) | CTYP_NOCLASS_NOTYPE) /*tmdlClock*/
...
#define CID_COMP_TIMER          (TAG(0x0A) | CTYP_NOCLASS_NOTYPE) /*tmdlTimer*/
...
#define CID_COMP_SERIAL_RAM     (TAG(0x14) | CTYP_NOCLASS_NOTYPE)
#define CID_COMP_SMARTMEDIA     (TAG(0x15) | CTYP_NOCLASS_NOTYPE)
#define CID_COMP_COMPACT_FLASH  (TAG(0x16) | CTYP_NOCLASS_NOTYPE)
#define CID_COMP_CI             (TAG(0x17) | CTYP_NOCLASS_NOTYPE)
#define CID_COMP_INT_ALARM      (TAG(0x18) | CTYP_NOCLASS_NOTYPE) /*tmClock*/
#define CID_COMP_TASK_ALARM     (TAG(0x19) | CTYP_NOCLASS_NOTYPE) /*tmSTimer*/
...
#define CID_COMP_SOURCE         (TAG(0x0E) | CTYP_NOCLASS_SOURCE)
...
#define CID_COMP_DEMUXDV        (TAG(0x03) | CTYP_NOCLASS_DEMUX)
...
#define CID_COMP_FWRITEFREAD    (TAG(0x0D) | CTYP_NOCLASS_FILTER)
...
#define CID_COMP_ATAPI_CMDS     (TAG(0x06) | CTYP_NOCLASS_DATABASE)

#define CID_COMP_IRDMMPEG       (TAG(0x01) | CTYP_NOCLASS_SUBSYS)
#define CID_COMP_STORSYS        (TAG(0x02) | CTYP_NOCLASS_SUBSYS)
#define CID_COMP_PMU            (TAG(0x03) | CTYP_NOCLASS_SUBSYS)
...
#define CID_COMP_CAM_SENSOR     (TAG(0x08) | CTYP_VIDEO_SOURCE)
...
#define CID_COMP_VDECTXT        (TAG(0x0F) | CTYP_VIDEO_DECODER)
#define CID_COMP_VDECDV         (TAG(0x10) | CTYP_VIDEO_DECODER)
...
#define CID_COMP_VTRANSDVD      (TAG(0x07) | CTYP_VIDEO_FILTER)
#define CID_COMP_VTRANSCRYSTAL  (TAG(0x08) | CTYP_VIDEO_FILTER)
#define CID_COMP_VTRANSUD       (TAG(0x09) | CTYP_VIDEO_FILTER)
...
#define CID_COMP_VSYSTV         (TAG(0x05) | CTYP_VIDEO_SUBSYS)
//
...
#define CID_COMP_CODEC          (TAG(0x01) | CTYP_AUDIO_NOTYPE)
...
#define CID_COMP_AVENCMPEG      (TAG(0x07) | CTYP_AUDIO_ENCODER)
...
#define CID_COMP_ADECPCM        (TAG(0x0B) | CTYP_AUDIO_DECODER)
#define CID_COMP_ADECDV         (TAG(0x0C) | CTYP_AUDIO_DECODER)
...
#define CID_COMP_APROC          (TAG(0x0D) | CTYP_AUDIO_FILTER)
...
#define CID_COMP_COMP_MMC       (TAG(0x04) | CTYP_AUDIO_SUBSYS)
...
#define CID_COMP_UDSPFL         (TAG(0x0D) | CTYP_BUS_NOTYPE)
#define CID_COMP_UDSRSL         (TAG(0x0E) | CTYP_BUS_NOTYPE)
#define CID_COMP_UDSMSBOT       (TAG(0x0F) | CTYP_BUS_NOTYPE)
#define CID_COMP_UDSMSCBI       (TAG(0x10) | CTYP_BUS_NOTYPE)
#define CID_COMP_UDSAUDIO       (TAG(0x11) | CTYP_BUS_NOTYPE)
#define CID_COMP_UDSHID         (TAG(0x12) | CTYP_BUS_NOTYPE)
#define CID_COMP_UDSCDC         (TAG(0x13) | CTYP_BUS_NOTYPE)
#define CID_COMP_UDSPRINTER     (TAG(0x14) | CTYP_BUS_NOTYPE)
#define CID_COMP_UDSSCSI        (TAG(0x15) | CTYP_BUS_NOTYPE)
#define CID_COMP_UDSMODEM       (TAG(0x16) | CTYP_BUS_NOTYPE)
#define CID_COMP_UDSETHERNET	(TAG(0x17) | CTYP_BUS_NOTYPE)
...
#define TM_ERR_PAUSE_PIN_REQUESTED          0x048 // Pause of a single pin is in progress
...
#define TM_ERR_BAD_FLAGS                    0x04D // Bad flags
#define TM_ERR_BAD_PRIORITY                 0x04E // Bad priority
#define TM_ERR_BAD_REFERENCE_COUNT          0x04F // Bad reference count
#define TM_ERR_BAD_SETUP                    0x050 // Bad setup
#define TM_ERR_BAD_STACK_SIZE               0x051 // Bad stack size
#define TM_ERR_BAD_TEE                      0x052 // Bad tee
#define TM_ERR_IN_PLACE                     0x053 // In place
#define TM_ERR_NOT_CACHE_ALIGNED            0x054 // Not cache aligned
#define TM_ERR_NO_ROOT_TEE                  0x055 // No root tee
#define TM_ERR_NO_TEE_ALLOWED               0x056 // No tee allowed
#define TM_ERR_NO_TEE_EMPTY_PACKET          0x057 // No tee empty packet
#define TM_ERR_NULL_PACKET                  0x059 // Null packet
#define TM_ERR_FORMAT_FREED                 0x05A // Format freed
#define TM_ERR_FORMAT_INTERNAL              0x05B // Format internal
#define TM_ERR_BAD_FORMAT                   0x05C // Bad format
#define TM_ERR_FORMAT_NEGOTIATE_SUBCLASS    0x05D // Format negotiate subclass
#define TM_ERR_FORMAT_NEGOTIATE_DATASUBTYPE 0x05E // Format negotiate datasubtype
#define TM_ERR_FORMAT_NEGOTIATE_DATATYPE    0x05F // Format negotiate datatype
#define TM_ERR_FORMAT_NEGOTIATE_DESCRIPTION 0x060 // Format negotiate description
#define TM_ERR_NULL_FORMAT                  0x061 // Null format
#define TM_ERR_FORMAT_REFERENCE_COUNT       0x062 // Format reference count
#define TM_ERR_FORMAT_NOT_UNIQUE            0x063 // Format not unique
#define TM_ERR_NEW_FORMAT                   0x064 // New format
#define TM_ERR_FUNC_FAILED                  0x065 // Function call failed
