...
void Settings::saveSettings() {
	...
	WritePrivateProfileString(_T("TeViiBDAPlugin"),_T("DeviceNumber"),temp, currentDirectory);
}
...
void Settings::loadSettings() {
	...
	devNumber	= GetPrivateProfileInt(_T("TeViiBDAPlugin"),_T("DeviceNumber"),0,currentDirectory);
}